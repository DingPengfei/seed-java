package com.seed.dialogue.llm.tool;
 ...
 * 默认实现存在问题
 */
public class SeedToolCallingManager implements ToolCallingManager {

    private static final Logger logger = LoggerFactory.getLogger(SeedToolCallingManager.class);
    ...
    public SeedToolCallingManager(ObservationRegistry observationRegistry, ToolCallbackResolver toolCallbackResolver,
    ...
    public ToolExecutionResult executeToolCalls(Prompt prompt, ChatResponse chatResponse) {
        ...
        SeedToolCallingManager.InternalToolExecutionResult internalToolExecutionResult = executeToolCall(prompt, toolCallMessage,
                toolContext);
     ...
     */
    private SeedToolCallingManager.InternalToolExecutionResult executeToolCall(Prompt prompt, AssistantMessage assistantMessage,
        ...
        return new SeedToolCallingManager.InternalToolExecutionResult(new ToolResponseMessage(toolResponses, Map.of()), returnDirect);
    }
    ...
    public static SeedToolCallingManager.Builder builder() {
        return new SeedToolCallingManager.Builder();
    }
    ...
    public final static class Builder {
        ...
        public SeedToolCallingManager.Builder observationRegistry(ObservationRegistry observationRegistry) {
            this.observationRegistry = observationRegistry;
            return this;
        }

        public SeedToolCallingManager.Builder toolCallbackResolver(ToolCallbackResolver toolCallbackResolver) {
            this.toolCallbackResolver = toolCallbackResolver;
            return this;
        }

        public SeedToolCallingManager.Builder toolExecutionExceptionProcessor(
                ToolExecutionExceptionProcessor toolExecutionExceptionProcessor) {
            this.toolExecutionExceptionProcessor = toolExecutionExceptionProcessor;
            return this;
        }
