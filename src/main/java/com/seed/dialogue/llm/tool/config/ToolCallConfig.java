package com.seed.dialogue.llm.tool.config;

import com.seed.dialogue.llm.tool.SeedToolCallingManager;
...
public class ToolCallConfig {
    ...
    public ToolCallingManager toolCallingManager(ObservationRegistry observationRegistry, ToolCallbackResolver toolCallbackResolver,
        ...
        return new SeedToolCallingManager(observationRegistry, toolCallbackResolver,
